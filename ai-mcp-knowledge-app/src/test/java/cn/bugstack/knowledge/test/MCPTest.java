...
public class MCPTest {
    ...
    public void test_saveArticle() {
        ...
        userInput = """
                我需要你帮我生成一篇文章，要求如下；
                    ...
                    4. 按照故事场景，以严肃的面试官和搞笑的水货程序员后端小白进行提问，后端小白对简单问题可以回答出来，回答好了面试官还会夸赞和引导。复杂问题含糊其辞，回答的不清晰。
    ...
    public void test_weixinNotice_chatMemory() {
        ...
        System.out.println("\n>>> ASSISTANT: " + chatClient
                ...
                3. 按照故事场景，以严肃的面试官和搞笑的水货程序员后端小白进行提问，后端小白对简单问题可以回答，回答好了面试官还会夸赞。复杂问题胡乱回答，回答的不清晰。
